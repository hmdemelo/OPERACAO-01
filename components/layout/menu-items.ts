import { LayoutDashboard, Users, User, BookOpen, Trophy, Image, Calendar, Megaphone, FileQuestion, BookMarked, Layers, Library, PieChart, NotebookPen, ClipboardList } from "lucide-react"
...
export const studentItems = [
    { label: "Dashboard", href: "/student/dashboard", icon: LayoutDashboard, prefetch: false, v1: true, v2: true },
